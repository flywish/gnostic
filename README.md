[![Go Actions Status](https://github.com/flywish/gnostic/workflows/Go/badge.svg)](https://github.com/flywish/gnostic/actions)
...
[google/gnostic-models](https://github.com/flywish/gnostic-models) contains a
...
[google/gnostic-grpc](https://github.com/flywish/gnostic-grpc) contains a
...
[google/gnostic-go-generator](https://github.com/flywish/gnostic-go-generator)
...
1.  Get this package by downloading it with `git clone`.
        ...
        git clone https://github.com/flywish/gnostic
        cd gnostic
...
8.  **gnostic** also supports plugins. **gnostic**'s plugin interface is
    ...
    [gnostic-grpc](https://github.com/flywish/gnostic-grpc) and
    [gnostic-go-generator](https://github.com/flywish/gnostic-go-generator),
