...
import (
	...
	wk "github.com/flywish/gnostic/cmd/protoc-gen-openapi/generator/wellknown"
	v3 "github.com/flywish/gnostic/openapiv3"
)
...
const (
	infoURL = "https://github.com/flywish/gnostic/tree/master/cmd/protoc-gen-openapi"
)
		...
		for _, method := range service.Methods {
			...
			for _, rule := range rules {
				...
				if methodName != "" {
					...
					if extOperation != nil {
						if len(extOperation.(*v3.Operation).Tags) > 0 {
							op.Tags = nil
						}
